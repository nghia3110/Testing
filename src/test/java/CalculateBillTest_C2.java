...
// Các ca kiểm thử được sinh ra từ các đường đi đạt 100% độ phủ C2

public class CalculateBillTest_C2 {
    @Test
    public void calculateBill_Test1() {
        final int expected = -1;
        final int actual = CalculateBill.calculateBill(-20, "Sinh hoạt");
